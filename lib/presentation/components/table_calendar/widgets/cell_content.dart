...
class CellContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final text = '${day.day}'.length < 2 ? '0${day.day}' : '${day.day}';
    ...
    if (isDisabled) {
      ...
      String currentDateString = DateFormat("yyyy-MM-dd").format(day);
      bool isTodayDate = todayDateString == currentDateString;
      cell = calendarBuilders.defaultBuilder?.call(context, day, focusedDay) ??
          AnimatedContainer(
            ...
            decoration: isTodayDate
                ? calendarStyle.todayDateDecoration
                : isWeekend
